...
elif [[ $IMAGE == "tal-berkovich" ]]; then
  SOURCE='Photo by <a href="https:\/\/unsplash.com\/@talberko?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Tal Berkovich<\/a> on <a href="https:\/\/unsplash.com\/photos\/2uKO-l-d7FA?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash<\/a>'
...
elif [[ $IMAGE == "eugene-golovesov" ]]; then
  SOURCE='Photo by <a href="https:\/\/unsplash.com\/@eugene_golovesov?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Eugene Golovesov<\/a> on <a href="https:\/\/unsplash.com\/photos\/4pn53hm4un0?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash<\/a>'
else
  exit 1
fi
